...
\begin{lstlisting}
void init_Lucas(){
	fac[0]=1; forto(i,1,P-1) fac[i]=fac[i-1]*i%P;
	inv[1]=1; forto(i,2,P-1) inv[i]=(P-P/i)*inv[P%i]%P;
	inv[0]=1; forto(i,1,P-1) inv[i]=inv[i-1]*inv[i]%P;
}
